...
@section('title')
MyBlog - Comments of Posts
@stop

@section('views_styles')
<!-- Styles for posts.comments view here -->
...
@section('content')
<h2 class="sub-header">
    <i class="glyphicon glyphicon-comment"></i> Comments of Post ( {{ $post->title }} )
    <div class="pull-right">
        <a class="btn btn-sm btn-default" href="{!! route('panel.posts.index') !!}"><i class="glyphicon glyphicon-chevron-left"></i> Back</a>
    </div>
</h2>
...
<!-- Scripts for posts.comments view here -->
